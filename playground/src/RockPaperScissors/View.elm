    ...
    div [ class "row justify-content-center" ]
        [ div [ class "col-auto col-md-4 rock-paper-scissors__scoreboard" ]
            [ div [ class "row" ]
                ...
                , div [ class "col-auto" ]
                    [ span [ class "rock-paper-scissors__scoreboard-text" ] [ text (Basics.toString model.computerScore) ] ]
                ]
            , div [ class "row" ]
                ...
                , div [ class "col-auto" ]
                    [ span [ class "rock-paper-scissors__scoreboard-text" ] [ text (Basics.toString model.userScore) ] ]
                ]
            ]
        ]
